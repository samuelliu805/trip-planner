...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      clear_route_variant_items_v3: {
        Args: {
          expected_item_versions: number[];
          expected_items_version: number;
          target_item_ids: string[];
          target_operation_id: string;
          target_trip_id: string;
      ...
      discard_research_asset_session_v2: {
        Args: {
          expected_research_version: number;
          requested_draft_session_id: string;
          target_research_item_id: string;
      ...
      remove_variant_day_v3: {
        Args: {
          expected_day_content_version: number;
          expected_day_version: number;
          expected_days_version: number;
          target_day_id: string;
          target_operation_id: string;
      ...
      trip_collaboration_storage_stats_v2: {
        Args: { target_trip_id: string };
        Returns: Json;
      };
    ...
    Enums: {
      ...
      itinerary_schedule_kind:
        "none" | "all_day" | "period" | "approximate" | "exact" | "range";
