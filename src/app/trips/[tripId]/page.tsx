...
export default async function TripPage({ params, searchParams }: TripPageProps) {
  ...
  return (
    <main className="h-[calc(100dvh-4rem)] overflow-hidden">
      <PlannerWorkspace initialWorkspace={workspace} trip={trip} deleteError={query.error === "delete"} settings={<div className="space-y-6"><UpdateTripForm trip={trip} /><div className="border-t pt-5"><DeleteTripDialog title={trip.title} tripId={trip.id} /></div></div>} />
    </main>
  );
}
