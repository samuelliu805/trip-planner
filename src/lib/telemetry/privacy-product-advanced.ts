...
export const advancedProductEventPropertyAllowlists = {
  ...
  idea_input_classified: [...advanced, "idea_kind", "classification_method"],
  idea_classification_overridden: [...advanced, "idea_kind", "classification_method"],
  idea_saved: [...advanced, "idea_kind"],
  idea_duplicate_merged: [...advanced, "idea_kind"],
  idea_parser_failed: [...advanced, "idea_kind", "error_code"],
  comparison_creation_started: [...advanced],
  comparison_created: [...advanced],
  comparison_choice_applied: [...advanced],
  comparison_choice_switched: [...advanced],
