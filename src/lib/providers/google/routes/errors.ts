...
const googleRouteMessages: Record<RouteProviderErrorCode, string> = {
...
export function googleRouteProviderError(code: RouteProviderErrorCode, cause?: unknown) {
  return new RouteProviderError(code, googleRouteMessages[code], { cause });
}
