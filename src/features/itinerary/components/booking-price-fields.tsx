  ...
  return (
    <div className="grid min-w-0 grid-cols-[minmax(0,1fr)_6.5rem] gap-3">
      ...
      <div className="min-w-0 space-y-1.5">
        ...
        <select
          className="flex h-11 w-full min-w-0 rounded-md border border-input bg-background px-3 py-2 text-base shadow-sm outline-none focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 sm:text-sm"
          disabled={disabled}
