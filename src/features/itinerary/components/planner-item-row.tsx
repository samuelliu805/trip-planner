...
export function PlannerItemRow({
  ...
  return (
    ...
    >
      <button
        className="flex min-h-8 min-w-0 flex-col justify-center rounded px-1.5 py-0.5 text-left text-[15px] leading-tight focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring min-[1200px]:min-h-7 min-[1200px]:py-0 min-[1200px]:text-[13px]"
