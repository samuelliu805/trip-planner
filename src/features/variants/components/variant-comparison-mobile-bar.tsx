...
export function VariantComparisonMobileBar({
  ...
  return (
    <div className="mobile-pull-up-panel absolute inset-x-2 bottom-2 z-20 flex flex-col overflow-hidden rounded-xl border bg-background/95 shadow-lg backdrop-blur min-[900px]:hidden">
