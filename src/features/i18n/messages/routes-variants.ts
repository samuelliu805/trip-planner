export const routesVariantsZhCN: Record<string, string> = {
  ...
  "Comparison summary": "对比摘要",
  Breakdown: "明细",
  "Choose comparison scope": "选择对比范围",
  "Compare whole trip": "对比全程路线",
  "Compare Day {day}": "对比第{day}天路线",
  "Select a day to compare": "选择一天后对比",
  "No places yet": "暂无地点",
  "Days & nights": "天数与住宿晚数",
  "Duplicate Plan": "复制方案",
  "Edit route": "编辑路线",
  ...
  "Close comparison summary": "关闭对比摘要",
