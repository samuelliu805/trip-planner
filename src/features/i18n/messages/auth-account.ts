export const authAccountZhCN: Record<string, string> = {
  ...
  "Logging in…": "正在登录…",
  "Show password": "显示密码",
  "8–32 characters with letters and numbers": "8–32 个字符，且同时包含字母和数字",
  "Use 8–32 characters with at least one letter and one number.":
    "请输入 8–32 个字符，并至少包含一个字母和一个数字。",
  ...
  "Phone number or password is incorrect.": "手机号或密码不正确。",
  "Reset password": "重置密码",
  "Resetting…": "正在重置…",
  "SMS code": "短信验证码",
  "Sign-in method": "登录方式",
  "The new passwords do not match.": "两次输入的新密码不一致。",
  "Use your current password to protect this account change.": "请输入当前密码以保护账户安全。",
  "Use your mainland China mobile number and create a password.": "使用中国大陆手机号并设置密码。",
