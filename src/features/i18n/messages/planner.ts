export const plannerZhCN: Record<string, string> = {
  ...
  "optional if a meal name is provided": "已填写餐厅名称时选填",
  "through Day": "到第",
  "Clear time": "清除时间",
  "https://": "https://",
  ...
  "Search AMap": "搜索高德地图",
  "Search origin on Maps": "在地图中搜索出发地",
  "Search destination on Maps": "在地图中搜索目的地",
  ...
  "Filled from the selected map place. Edit if needed.": "已根据所选地图地点填写，可按需修改。",
  "Leave blank to display the selected map place name.": "留空时将显示所选地图地点的名称。",
  "Use “{query}”": "使用“{query}”",
