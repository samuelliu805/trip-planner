...
- Compact output must be lossless: store the complete log privately, print stage and duration on success, and print a bounded tail plus full-log path on failure. Never emit secret values.
