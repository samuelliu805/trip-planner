...
RUN APP_REGION=cn \
  ...
  CLOUDBASE_ENV_ID=__TRIP_PLANNER_CLOUDBASE_ENV_ID__ \
  CLOUDBASE_PUBLISHABLE_KEY=__TRIP_PLANNER_CLOUDBASE_SERVER_KEY__ \
  CLOUDBASE_REGION=__TRIP_PLANNER_CLOUDBASE_REGION__ \
  ...
  NEXT_PUBLIC_CLOUDBASE_REGION=__TRIP_PLANNER_NEXT_PUBLIC_CLOUDBASE_REGION__ \
