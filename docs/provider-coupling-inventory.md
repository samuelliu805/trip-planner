...
| `.github/workflows/phase-5-dual-environment.yml` | Protected exact-SHA static, Global Preview/Supabase, and CN/CloudBase verification. | H: live non-production credentials | Phase 5; manual dispatch only    |
