...
| `share_export_started`, `share_exported`, `share_export_failed`                                          | Does Timeline image export finish? Long-image generate owner.                                                     | Finalize/fail RPC is the single authoritative outcome owner.                                                                                     | `share_artifact=image`, `export_mode`, `surface`, failure `error_code` | Authenticated; matching operation.                           | Export a disposable image / render, upload, and finalize failure tests.                             |
