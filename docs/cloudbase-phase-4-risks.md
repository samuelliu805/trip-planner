...
| ---------------------- | ------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------- |
| AMap capability        | Phase 4 closed fail-closed. The Phase 5 adapter is implemented; no real-key live smoke is claimed yet. | Provider-local isolation/static checks and the protected real CN map, Places, and Routes smoke all pass on one candidate SHA.          |
| Logging and alerts     | CLS and alert routing are disabled.                                                                    | Manually enable scoped CloudBase logging and route actionable alerts to the named owner destination.                                   |
| Backup/restore         | No disposable-target restore has been performed.                                                       | Complete and record an actual backup/restore drill without touching production data.                                                   |
