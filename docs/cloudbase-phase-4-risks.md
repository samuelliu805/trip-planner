...
| ---------------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| AMap capability        | The Phase 4 selector fails closed; no AMap smoke is claimed.                           | Provider-local map, Places, Routes, coordinate conversion, isolation tests, and a real CN smoke.                                       |
