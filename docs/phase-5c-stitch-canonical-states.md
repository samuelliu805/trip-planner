...
| Phase 5C — Decision Summary · Desktop · Summary Expanded        | 4743d4bcdb8047a1b6838da8f873fc31 | Desktop     | A compact, collapsible summary presents at most three variant columns with Primary as the baseline and the active route labeled Editing            | RouteVariantDecisionSummaryPanel, DecisionSummaryCard, and focused card detail components             |
...
| Phase 5C — Decision Summary · Desktop · Partial & Unknown State | 4bce4c12ffa74028b6c90d0f69ed86bd | Desktop     | Comparable incomplete dates, missing calculations, stale routes, and excluded per-mode distance totals are explicit                                | DecisionSummaryCard, DecisionSummaryCoverageDetails, and focused route/City derivation modules        |
