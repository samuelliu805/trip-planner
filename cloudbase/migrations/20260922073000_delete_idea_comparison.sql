-- Generated CloudBase migration from database/shared/migrations/20260922073000_delete_idea_comparison.sql.
...
REVOKE EXECUTE ON FUNCTION public.delete_idea_comparison_v1(uuid,uuid,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.delete_idea_comparison_v1(uuid,uuid,uuid) TO authenticated;
