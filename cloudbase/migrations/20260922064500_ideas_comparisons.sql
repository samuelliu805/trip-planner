-- Generated CloudBase migration from database/shared/migrations/20260922064500_ideas_comparisons.sql.
...
GRANT EXECUTE ON FUNCTION public.apply_single_idea_v1(uuid,uuid,uuid,uuid,uuid,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.capture_idea_v1(uuid,uuid,text,text,text,text,jsonb) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.capture_idea_v1(uuid,uuid,text,text,text,text,jsonb) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.create_idea_comparison_v1(uuid,text,jsonb) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.create_idea_comparison_v1(uuid,text,jsonb) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.list_idea_comparisons_v1(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.list_idea_comparisons_v1(uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.merge_idea_source_v1(uuid,uuid,bigint,text,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.merge_idea_source_v1(uuid,uuid,bigint,text,uuid) TO authenticated;
