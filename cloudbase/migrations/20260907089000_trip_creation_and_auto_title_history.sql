-- Generated CloudBase migration from database/shared/migrations/20260907089000_trip_creation_and_auto_title_history.sql.
...
REVOKE EXECUTE ON FUNCTION public.create_trip_v3(text,text,text,text,integer,date,date,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.create_trip_v3(text,text,text,text,integer,date,date,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.rename_trip_if_title_v2(uuid,text,text,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.rename_trip_if_title_v2(uuid,text,text,bigint,uuid) TO authenticated;
