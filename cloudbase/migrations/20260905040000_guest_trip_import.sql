-- Generated CloudBase migration from database/shared/migrations/20260905040000_guest_trip_import.sql.
...
CREATE OR REPLACE FUNCTION public.import_guest_trip_v1(
  guest_draft_id uuid,
  guest_payload jsonb,
  guest_locale text DEFAULT 'en'
) RETURNS uuid
...
REVOKE EXECUTE ON FUNCTION public.import_guest_trip_v1(uuid,jsonb,text) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.import_guest_trip_v1(uuid,jsonb,text) TO authenticated;
