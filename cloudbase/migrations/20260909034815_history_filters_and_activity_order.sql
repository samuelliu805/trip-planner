-- Generated CloudBase migration from database/shared/migrations/20260909034815_history_filters_and_activity_order.sql.
...
REVOKE EXECUTE ON FUNCTION public.list_trip_history_filter_options_v1(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.list_trip_history_filter_options_v1(uuid) TO authenticated;
