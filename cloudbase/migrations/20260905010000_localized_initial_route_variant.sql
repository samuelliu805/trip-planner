-- Generated CloudBase migration from database/shared/migrations/20260905010000_localized_initial_route_variant.sql.
...
VALUES ('20260905010000', 'Localize the initial route variant name')
ON CONFLICT (version) DO NOTHING;

-- Generated fail-closed function ACLs. Review rpc-allowlist.json before granting a browser role.
REVOKE EXECUTE ON FUNCTION public.create_trip_v2(text,date,date,text,text,integer,text) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.create_trip_v2(text,date,date,text,text,integer,text) TO authenticated;
