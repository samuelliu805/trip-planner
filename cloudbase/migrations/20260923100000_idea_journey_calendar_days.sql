-- Generated CloudBase migration from database/shared/migrations/20260923100000_idea_journey_calendar_days.sql.
...
REVOKE EXECUTE ON FUNCTION app_private.ensure_idea_plan_day(uuid,uuid,date) FROM PUBLIC, anon, authenticated;
