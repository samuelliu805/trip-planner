-- Generated CloudBase migration from database/shared/migrations/20260906020000_trip_collaboration_history_optimistic_lock.sql.
...
REVOKE EXECUTE ON FUNCTION app_private.audit_itinerary_item() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION app_private.guard_trip_owner_identity() FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.can_edit_trip(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.can_edit_trip(uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.delete_trip_v1(uuid,bigint) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.delete_trip_v1(uuid,bigint) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.invite_trip_collaborator(uuid,text,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.invite_trip_collaborator(uuid,text,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.is_actual_trip_owner(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.is_actual_trip_owner(uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.is_trip_owner(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.is_trip_owner(uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.list_trip_history(uuid,timestamptz,uuid,integer) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.list_trip_history(uuid,timestamptz,uuid,integer) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.list_trip_members(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.list_trip_members(uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.remove_trip_collaborator(uuid,uuid,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.remove_trip_collaborator(uuid,uuid,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.update_trip_plan(uuid,text,date,date,integer,text,text,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.update_trip_plan(uuid,text,date,date,integer,text,text,bigint,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.update_trip_status(uuid,text,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.update_trip_status(uuid,text,bigint,uuid) TO authenticated;
