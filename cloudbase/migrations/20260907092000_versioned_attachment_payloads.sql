-- Generated CloudBase migration from database/shared/migrations/20260907092000_versioned_attachment_payloads.sql.
...
REVOKE EXECUTE ON FUNCTION public.asset_link_owner_json_v2(uuid) FROM PUBLIC, anon, authenticated;
