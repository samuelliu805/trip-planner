-- Generated CloudBase migration from database/shared/migrations/20260907082000_collaborative_share_page_transactions.sql.
...
REVOKE EXECUTE ON FUNCTION app_private.share_settings_json(public_itinerary_links) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION app_private.validate_share_settings(uuid,integer,text,integer,text,uuid,integer,integer) FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.enforce_public_itinerary_link_owner() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.list_share_pages_v2(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.list_share_pages_v2(uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.owner_share_page_v2(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.owner_share_page_v2(uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.revoke_share_page_v2(uuid,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.revoke_share_page_v2(uuid,bigint,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.update_share_page_v4(uuid,bigint,uuid,public_itinerary_view,boolean,boolean,boolean,boolean,boolean,boolean,boolean,text,text,text,integer,boolean,text,uuid,integer,integer,boolean) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.update_share_page_v4(uuid,bigint,uuid,public_itinerary_view,boolean,boolean,boolean,boolean,boolean,boolean,boolean,text,text,text,integer,boolean,text,uuid,integer,integer,boolean) TO authenticated;
