-- Generated CloudBase migration from database/shared/migrations/20260907100000_close_collaboration_history_gaps.sql.
...
REVOKE EXECUTE ON FUNCTION app_private.bump_content_from_asset_link() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION app_private.bump_content_from_day() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION app_private.bump_content_from_item_link() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION app_private.bump_day_content_from_route_child() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION app_private.bump_trip_content_version() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION app_private.bump_variant_day_content_version() FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION app_private.complete_wrapped_operation(uuid,uuid,uuid,text,text,uuid,text,jsonb) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.cleanup_collaboration_replay_v1(integer) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.clear_route_variant_items_v3(uuid,uuid,uuid[],bigint[],bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.clear_route_variant_items_v3(uuid,uuid,uuid[],bigint[],bigint,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.copy_itinerary_items_v3(uuid,uuid,uuid[],bigint[],uuid[],bigint[],uuid,boolean,bigint,uuid) FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.copy_research_assets_to_items_v1(uuid,uuid,uuid,uuid[]) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.create_route_variant_v3(uuid,uuid,text,text,uuid,boolean,bigint,bigint,bigint,bigint) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.create_route_variant_v3(uuid,uuid,text,text,uuid,boolean,bigint,bigint,bigint,bigint) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.delete_route_variant_v3(uuid,uuid,bigint,bigint,bigint,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.delete_route_variant_v3(uuid,uuid,bigint,bigint,bigint,bigint,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.delete_trip_v3(uuid,bigint,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.delete_trip_v3(uuid,bigint,bigint,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.detach_research_asset_v3(uuid,uuid,text,bigint,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.detach_research_asset_v3(uuid,uuid,text,bigint,bigint,uuid) TO authenticated;
...
REVOKE EXECUTE ON FUNCTION public.discard_research_asset_session_v2(uuid,uuid,uuid,bigint) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.discard_research_asset_session_v2(uuid,uuid,uuid,bigint) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.finalize_research_asset_v2(uuid,uuid,uuid,bigint,text,bigint,asset_media_kind,text,integer,integer,numeric,boolean) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.finalize_research_asset_v2(uuid,uuid,uuid,bigint,text,bigint,asset_media_kind,text,integer,integer,numeric,boolean) TO authenticated;
...
REVOKE EXECUTE ON FUNCTION public.prepare_research_asset_v2(uuid,uuid,text,text,bigint,asset_media_kind,text,uuid,bigint) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.prepare_research_asset_v2(uuid,uuid,text,text,bigint,asset_media_kind,text,uuid,bigint) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.remove_variant_day_v3(uuid,uuid,uuid,bigint,bigint,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.remove_variant_day_v3(uuid,uuid,uuid,bigint,bigint,bigint,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.save_research_item_v3(uuid,uuid,bigint,jsonb,uuid,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.save_research_item_v3(uuid,uuid,bigint,jsonb,uuid,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.trip_collaboration_storage_stats_v2(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.trip_collaboration_storage_stats_v2(uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.update_trip_plan_v2(uuid,text,date,date,integer,text,text,bigint,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.update_trip_plan_v2(uuid,text,date,date,integer,text,text,bigint,bigint,uuid) TO authenticated;
