-- CloudBase's PG gateway serializes scalar SQL booleans as empty objects. Return a JSON boolean so
-- the current-user RPC still reaches the application as the strict boolean true/false contract.
BEGIN;

SET LOCAL lock_timeout = '5s';
SET LOCAL statement_timeout = '120s';

DROP FUNCTION public.owns_pending_share_image_object_v1(text);
...
VALUES ('20260831204500', 'CloudBase boolean RPC JSON compatibility');
