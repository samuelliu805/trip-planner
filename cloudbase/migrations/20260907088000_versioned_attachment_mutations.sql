-- Generated CloudBase migration from database/shared/migrations/20260907088000_versioned_attachment_mutations.sql.
...
REVOKE EXECUTE ON FUNCTION app_private.asset_link_member_json(uuid) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.detach_item_asset_v2(uuid,uuid,text,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.detach_item_asset_v2(uuid,uuid,text,bigint,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.detach_research_asset_v2(uuid,uuid,text,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.detach_research_asset_v2(uuid,uuid,text,bigint,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.set_item_asset_share_v3(uuid,uuid,text,boolean,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.set_item_asset_share_v3(uuid,uuid,text,boolean,bigint,uuid) TO authenticated;
