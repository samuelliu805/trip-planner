-- Generated CloudBase migration from database/shared/migrations/20260901181000_provider_neutral_places_and_amap_public_routes.sql.
...
REVOKE EXECUTE ON FUNCTION app_private.add_public_amap_route_geometry_v1(uuid,jsonb) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.get_public_itinerary_v4(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.get_public_itinerary_v4(uuid) TO anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.upsert_google_place_snapshot_v2(uuid,text,text,text,double precision,double precision,text,text,text,text) FROM PUBLIC, anon, authenticated;
...
REVOKE EXECUTE ON FUNCTION public.upsert_place_snapshot_v3(uuid,text,text,text,text,double precision,double precision,text,text,text,text,text,text) FROM PUBLIC, anon, authenticated;
