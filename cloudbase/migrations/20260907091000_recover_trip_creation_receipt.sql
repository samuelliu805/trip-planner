-- Generated CloudBase migration from database/shared/migrations/20260907091000_recover_trip_creation_receipt.sql.
...
REVOKE EXECUTE ON FUNCTION public.recover_trip_creation_v1(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.recover_trip_creation_v1(uuid) TO authenticated;
