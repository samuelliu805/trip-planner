-- Generated CloudBase migration from database/shared/migrations/20260907085000_research_apply_and_share_image_membership.sql.
...
REVOKE EXECUTE ON FUNCTION public.apply_research_item_to_variant_v3(uuid,uuid,uuid,text,uuid,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.apply_research_item_to_variant_v3(uuid,uuid,uuid,text,uuid,bigint,uuid) TO authenticated;
...
REVOKE EXECUTE ON FUNCTION public.revert_research_plan_application_v2(uuid,uuid,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.revert_research_plan_application_v2(uuid,uuid,bigint,uuid) TO authenticated;
