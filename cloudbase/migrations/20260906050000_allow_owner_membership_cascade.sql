-- Generated CloudBase migration from database/shared/migrations/20260906050000_allow_owner_membership_cascade.sql.
...
BEGIN
  ...
  IF TG_OP = 'DELETE' AND OLD.role::text = 'owner'
    AND expected_owner IS NOT NULL AND pg_trigger_depth() < 2
  THEN
