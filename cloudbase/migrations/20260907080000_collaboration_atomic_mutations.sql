-- Generated CloudBase migration from database/shared/migrations/20260907080000_collaboration_atomic_mutations.sql.
...
REVOKE EXECUTE ON FUNCTION app_private.operation_fingerprint(text,text,uuid,jsonb) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION app_private.safe_jsonb_diff(jsonb,jsonb,text) FROM PUBLIC, anon, authenticated;
REVOKE EXECUTE ON FUNCTION public.current_research_plan_application_ids(uuid,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.current_research_plan_application_ids(uuid,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.delete_itinerary_item_v2(uuid,uuid,uuid,bigint,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.delete_itinerary_item_v2(uuid,uuid,uuid,bigint,bigint,uuid) TO authenticated;
...
REVOKE EXECUTE ON FUNCTION public.save_itinerary_item_v2(uuid,uuid,uuid,uuid,jsonb,jsonb,uuid[],bigint,bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.save_itinerary_item_v2(uuid,uuid,uuid,uuid,jsonb,jsonb,uuid[],bigint,bigint,uuid) TO authenticated;
REVOKE EXECUTE ON FUNCTION public.trip_history_storage_stats(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.trip_history_storage_stats(uuid) TO authenticated;
