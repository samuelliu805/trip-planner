-- Generated CloudBase migration from database/shared/migrations/20260907090000_reorder_days_optimistic_transaction.sql.
...
REVOKE EXECUTE ON FUNCTION public.reorder_variant_days_v2(uuid,uuid,uuid[],bigint,uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.reorder_variant_days_v2(uuid,uuid,uuid[],bigint,uuid) TO authenticated;
